...
def load_RPDR_phy_multiple(dir_data, fname, delimiter='|'):
    ...
    for subdir in subdirectories:
        ...
        path = load_RPDR_phy(path_to_path, delimiter=delimiter)
...
def load_RPDR_phy(path, delimiter='|', datetime_col='Date'):
    ...
    path_df['datetime'] = pd.to_datetime(path_df['Date'], errors='ignore')
