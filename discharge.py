...
def load_RPDR_dis_multiple(dir_data, fname, delimiter='|', datetime_col='Report_Date_Time'):
    ''' load_RPDR_dis_multiple(dir_data, fname, delimiter='\t', datetime_col='Report_Date_Time'):
...
def load_RPDR_dis(path,delimiter='|', datetime_col='Report_Date_Time'):
    ''' load_RPDR_dis(path, delimiter='|', datetime_col='Report_Date_Time'):
        Loads RPDR discharge file as pandas dataframe
